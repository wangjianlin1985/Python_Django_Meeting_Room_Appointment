...
urlpatterns = [
    ...
    url(r'^PlaceType/', include('apps.PlaceType.urls', namespace='PlaceType')),  # 会议室类型模块
    url(r'^Place/', include('apps.Place.urls', namespace='Place')),  # 会议室模块
    url(r'^OrderInfo/', include('apps.OrderInfo.urls', namespace='OrderInfo')),  # 预约订单模块
    url(r'^PayWay/', include('apps.PayWay.urls', namespace='PayWay')),  # 支付方式模块
    url(r'^TimeInterval/', include('apps.TimeInterval.urls', namespace='TimeInterval')),  # 时段模块
